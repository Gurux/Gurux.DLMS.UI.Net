...
//
//
// Filename:        $HeadURL: svn://mars/Projects/GuruxClub/GXDLMSDirector/Development/Views/GXDLMSPrimeNbOfdmPlcPhysicalLayerCountersView.cs $
//
...
namespace Gurux.DLMS.UI
{
    ...
    /// </summary>
    [GXDLMSViewAttribute(typeof(GXDLMSPrimeNbOfdmPlcPhysicalLayerCounters))]
    partial class GXDLMSPrimeNbOfdmPlcPhysicalLayerCountersView : Form, IGXDLMSView
    {

        /// <summary>
        /// Constructor.
        /// </summary>
        public GXDLMSPrimeNbOfdmPlcPhysicalLayerCountersView()
        {
            InitializeComponent();
        }
        ...
        public void OnDirtyChange(int index, bool Dirty)
        {
            if (Dirty)
            {
                ...
                {
                    errorProvider1.SetError(CRCFailedCountTb, Properties.Resources.ValueChangedTxt);
                }
                else if (index == 4)
                {
                    errorProvider1.SetError(TXDropCountTb, Properties.Resources.ValueChangedTxt);
                }
                else if (index == 5)
                {
                    errorProvider1.SetError(RXDropCountTb, Properties.Resources.ValueChangedTxt);
                }
            }
            else
            {
