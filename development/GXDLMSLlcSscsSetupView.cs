...
//
//
// Filename:        $HeadURL: svn://mars/Projects/GuruxClub/GXDLMSDirector/Development/Views/GXDLMSLlcSscsSetupView.cs $
//
...
namespace Gurux.DLMS.UI
{
    ...
    /// </summary>
    [GXDLMSViewAttribute(typeof(GXDLMSLlcSscsSetup))]
    partial class GXDLMSLlcSscsSetupView : Form, IGXDLMSView
    {

        /// <summary>
        /// Constructor.
        /// </summary>
        public GXDLMSLlcSscsSetupView()
        {
            InitializeComponent();
        }
        ...
        public void OnDirtyChange(int index, bool Dirty)
        {
            ...
            {
                errorProvider1.SetError(BaseAddressTb, Properties.Resources.ValueChangedTxt);
            }
            else
            {
